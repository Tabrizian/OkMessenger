...
<?php include_layout_template('profile-header.php'); ?>
    ...
    <div class="row">
        ...
        <div
            class="col-xs-12 col-sm-12 col-md-6 col-lg-9 col-xs-offset-0 col-sm-offset-0 col-md-offset-3 col-lg-offset-1 toppad">
            ...
            <div class="col-md-8 col-sm-6 col-xs-12 personal-info">
                ...
                <form class="form-horizontal" role="form" method="post" action="edit_profile.php">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input class="form-control" name="email_address" value="<?php echo $user->email_address; ?>"
                                   type="email">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-md-2">
                            <input class="form-control" name="year" placeholder="Year" type="number" min="1900"
                                   max="2016" value="value="
